...
import {
    Brain, Zap, CircleCheck, RefreshCw,
        ...
        try {
            ...
            pending.forEach(req => {
                const reqForEngine = {
                    ...
                    urgencyLevel: req.urgencyLevel || req.urgency_level,
                };
                                ...
                                >
                                    <div style={{ flex: 1, minWidth: 200 }}>
                                        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 4 }}>
                                            ...
                                            <span style={{ fontSize: 15, fontWeight: 800, color: 'var(--text-primary)' }}>{req.serviceType || req.service_type}</span>
                                            <Badge variant={(req.urgencyLevel || req.urgency_level) === 'HIGH' ? 'HIGH' : (req.urgencyLevel || req.urgency_level) === 'MEDIUM' ? 'MEDIUM' : 'LOW'}>
                                                {req.urgencyLevel || req.urgency_level}
                                            </Badge>
                                        </div>
                                        <div style={{ display: 'flex', gap: 14, fontSize: 12, color: 'var(--text-muted)' }}>
                                            <span>📍 {req.location}</span>
                                            <span>👤 {req.requesterName || req.requester_name}</span>
                                        </div>
                                    </div>
