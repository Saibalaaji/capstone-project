import { TrendingUp, CircleCheck, Brain, Sparkles, MapPin, BarChart3, Star } from 'lucide-react';
import {
...
export default function AdminAnalytics({ requests = [], volunteers = [], adaptiveData }) {
    ...
    const kpis = [
        ...
        { label: 'Requests Closed',   value: adaptiveData?.totalOutcomes || 0,                          icon: CircleCheck,  color: 'mint' },
