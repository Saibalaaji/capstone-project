...
import { User, Mail, Phone, MapPin, Briefcase, Calendar, Home, CircleCheck, CircleX, UserPlus } from 'lucide-react';
            ...
            <div className="main-content" style={{ padding: '40px 24px', maxWidth: 800, margin: '0 auto' }}>
                ...
                {toast && (
                    <div className={`toast ${toast.type}`}>
                        {toast.type === 'success' && <CircleCheck size={18} color="var(--accent-green)" />}
                        {toast.type === 'error' && <CircleX size={18} color="var(--accent-rose)" />}
