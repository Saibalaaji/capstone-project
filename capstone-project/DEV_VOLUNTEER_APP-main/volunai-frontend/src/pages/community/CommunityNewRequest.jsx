import { CirclePlus, ClipboardList, Zap, MapPin, Phone, User } from 'lucide-react';
import { interpretRequest } from '../../services/aiEngine';
        ...
        <div className="animate-fadeIn">
            ...
            <form onSubmit={onSubmit}>
                <div className="grid-2" style={{ marginBottom: 20 }}>
                    <Card>
                        ...
                        {[
                            ...
                            <div key={f.name} className="form-group" style={{ gridColumn: '1 / -1' }}>
                        ...
                        <div className="form-group" style={{ gridColumn: '1 / -1' }}>
                            ...
                            <LocationPickerMap 
                                ...
                                height={200}
                            />
                            {!form.lat && <div style={{ fontSize: 11, color: 'var(--coral)', marginTop: 4 }}>* Please tap the map to pin the exact location where help is needed.</div>}
                        </div>
                    </Card>
                ...
                <Card>
                    ...
                    <div className="form-group">
                        <textarea
                            name="description" value={form.description || ''} onChange={handleDescriptionChange}
